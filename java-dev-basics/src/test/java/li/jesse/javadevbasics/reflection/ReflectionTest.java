package li.jesse.javadevbasics.reflection;

import li.jesse.javadevbasics.entity.Animal;
import li.jesse.javadevbasics.entity.User;
import li.jesse.javadevbasics.util.AnimalFactory;
...
public class ReflectionTest implements Serializable {
    ...
    public void testInstantiateClassObject() throws ClassNotFoundException {
        ...
        clazz1 = Class.forName("li.jesse.javadevbasics.reflection.ReflectionTest");
    ...
    public void testGetParentClassOfAnOjbect() throws ClassNotFoundException {
        Class<?> clazz = Class.forName("li.jesse.javadevbasics.reflection.ReflectionTest");
    ...
    public void testReflection04() throws Exception {
        Class<?> clazz01 = Class.forName("li.jesse.javadevbasics.entity.User");
    ...
    public void testReflection05() throws ClassNotFoundException {
        Class<?> clazz = Class.forName("li.jesse.javadevbasics.entity.User");
...
//        method.invoke(clazz.newInstance());
    ...
    public void testReflectionD() {
        Animal animal = AnimalFactory.getInstance("Monkey");
