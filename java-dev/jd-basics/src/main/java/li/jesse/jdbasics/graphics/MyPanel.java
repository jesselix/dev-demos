package li.jesse.jdbasics.graphics;
...
public class MyPanel extends JPanel {
    ...
    private void drawRect(Graphics g) {
        ...
        g2d.drawRect(300, 20, 80, 100);

        // 2. 填充一个矩形
        g2d.fillRect(500, 20, 80, 100);

        // 3. 绘制一个圆角矩形: 起点(30, 150), 宽80, 高100, 圆角宽30, 圆角高30
        g2d.drawRoundRect(300, 150, 80, 100, 30, 30);

        // 4. 绘制一个多边形(收尾相连): 点(140, 150), 点(180, 250), 点(220, 200)
        int[] xPoints = new int[] { 500, 580, 550};
        int[] yPoints = new int[] { 150,  200, 250};
        int nPoints = 3;
    ...
    private void drawString(Graphics g) {
        ...
        // 首次绘制需要初始化字体, 可能需要较耗时
        g2d.drawString("Hello World!", 50, 300);
        g2d.drawString("你好, 世界!", 50, 360);
